...
type Status = "Approved" | "Pending" | "Assigned";
      ...
      <PageHeader
        ...
        actions={
          <div className="flex gap-2">
            ...
            <Link href="/driver/history" className="btn btn-outline">
              Trip History
            </Link>
          </div>
        }
          ...
          <div className="flex items-center justify-between px-4 sm:px-5 py-3 border-b border-neutral-200/80">
            ...
            <div className="hidden md:flex items-center gap-3 text-xs text-neutral-500">
              <span className="inline-flex items-center gap-1">
                <span className="h-2 w-2 rounded-full bg-green-600/80"></span> Approved
              </span>
              <span className="inline-flex items-center gap-1">
                <span className="h-2 w-2 rounded-full bg-amber-600/80"></span> Pending
              </span>
              <span className="inline-flex items-center gap-1">
                <span className="h-2 w-2 rounded-full bg-blue-600/80"></span> Assigned
              </span>
            </div>
          </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 sm:px-5 py-3">
                        <div className="flex items-center gap-2">
                          <Link
                            href={`/driver/schedule/${r.id}`}
                            className="inline-flex items-center gap-1 rounded-full border border-neutral-300 bg-white px-3 py-1.5 text-xs font-medium text-neutral-700 hover:bg-neutral-50"
                          >
                            View
                          </Link>
                          <Link
                            href={`/driver/status?trip=${r.id}`}
                            className="inline-flex items-center gap-1 rounded-full border border-[#7a0019]/20 bg-[#7a0019]/10 px-3 py-1.5 text-xs font-medium text-[#7a0019] hover:bg-[#7a0019]/15"
                          >
