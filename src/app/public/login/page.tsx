...
export default function Home() {
  ...
  const handleLogin = () => {
    // (Optional) Mark as logged in — can be used for guarding dashboard
    localStorage.setItem("tl_logged_in", "1");

    // Redirect to your dashboard route
    router.push("/admin"); // or "/admin/dashboard" depending on folder setup
  };
    ...
    <div className="flex min-h-screen font-sans bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <main className="flex-1 flex flex-col lg:flex-row">
        ...
        >
          ...
          <div className="relative bg-white shadow-2xl rounded-xl p-10 w-96 border border-gray-200 z-10">
            ...
            <h2 className="text-xl font-bold border-b pb-3 mb-6 text-gray-800">
              User Login
            </h2>
            <div className="mb-5">
            ...
            <button
              onClick={handleLogin}
              className="bg-red-900 text-white w-full py-3 rounded-md hover:bg-red-800 transition-all font-medium text-sm shadow-md"
            >
              Login
            </button>
