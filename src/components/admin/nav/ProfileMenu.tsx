...
export default function ProfileMenu() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-white/30 text-[13px] font-semibold">A</span>
      ...
      {open && (
        <div role="menu" className="absolute right-0 mt-2 w-80 max-w-[92vw] rounded-xl bg-neutral-900/95 p-2 text-white shadow-2xl ring-1 ring-white/10 backdrop-blur">
          <Link href="/admin/profile" className="flex items-center gap-3 rounded-lg p-2 hover:bg-white/10" role="menuitem" onClick={() => setOpen(false)}>
          ...
          <Link href="/admin/org/ccms" className="mt-1 flex items-center gap-3 rounded-lg p-2 hover:bg-white/10" role="menuitem" onClick={() => setOpen(false)}>
            <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/20 text-sm font-semibold">TL</span>
            <div className="flex flex-col">
          ...
          <Link href="/admin/settings" className="flex items-center gap-3 rounded-lg p-2 hover:bg-white/10" role="menuitem" onClick={() => setOpen(false)}>
            <GearIcon />
          ...
          <Link href="/admin/help" className="flex items-center gap-3 rounded-lg p-2 hover:bg-white/10" role="menuitem" onClick={() => setOpen(false)}>
            <HelpIcon />
            <div className="flex-1">
          ...
          <button className="w-full flex items-center gap-3 rounded-lg p-2 hover:bg-white/10" role="menuitem" onClick={() => setOpen(false)}>
            <DisplayIcon />
          ...
          <button onClick={logout} className="w-full flex items-center gap-3 rounded-lg p-2 text-red-200 hover:bg-white/10" role="menuitem">
            <LogoutIcon />
